...
ENTITIES = [
    ...
    # Additional entities to push the fixture past 40k LOC for the 40k-fanout test.
    ("task", "Task", "tasks", ["id", "title", "projectId", "assigneeId", "status", "priority", "dueAt", "createdAt"]),
    ("label", "Label", "labels", ["id", "name", "color", "repositoryId", "description", "createdAt"]),
    ("milestone", "Milestone", "milestones", ["id", "title", "repositoryId", "dueAt", "state", "description", "createdAt"]),
    ("branch", "Branch", "branches", ["id", "name", "repositoryId", "commitSha", "isProtected", "createdAt"]),
    ("tag", "Tag", "tags", ["id", "name", "repositoryId", "commitSha", "message", "createdAt"]),
    ("release", "Release", "releases", ["id", "tag", "repositoryId", "name", "body", "publishedAt", "createdAt"]),
    ("asset", "Asset", "assets", ["id", "releaseId", "name", "contentType", "amountCents", "downloadCount", "createdAt"]),
    ("attachment", "Attachment", "attachments", ["id", "parentId", "parentKind", "name", "contentType", "sizeCents", "uploadedAt"]),
    ("alert", "Alert", "alerts", ["id", "ruleId", "subjectId", "severity", "status", "firedAt", "resolvedAt"]),
    ("logEntry", "LogEntry", "logEntries", ["id", "level", "message", "source", "metadata", "recordedAt"]),
    ("metric", "Metric", "metrics", ["id", "name", "unit", "quantity", "metadata", "recordedAt"]),
    ("eventRecord", "EventRecord", "eventRecords", ["id", "name", "source", "subjectId", "metadata", "recordedAt"]),
    ("span", "Span", "spans", ["id", "traceId", "parentSpanId", "operationName", "amountCents", "startedAt", "endedAt"]),
    ("trace", "Trace", "traces", ["id", "name", "rootSpanId", "amountCents", "startedAt", "endedAt"]),
    ("backup", "Backup", "backups", ["id", "subjectId", "subjectKind", "status", "metadata", "startedAt", "completedAt"]),
    ("snapshot", "Snapshot", "snapshots", ["id", "subjectId", "subjectKind", "version", "metadata", "createdAt"]),
    ("schedule", "Schedule", "schedules", ["id", "name", "cron", "ownerId", "active", "nextRunAt", "createdAt"]),
    ("cronJob", "CronJob", "cronJobs", ["id", "scheduleId", "command", "status", "lastRunAt", "nextRunAt"]),
    ("secret", "Secret", "secrets", ["id", "name", "ownerId", "valueRef", "rotatedAt", "expiresAt", "createdAt"]),
    ("credential", "Credential", "credentials", ["id", "name", "ownerId", "kind", "expiresAt", "createdAt"]),
    ("certificate", "Certificate", "certificates", ["id", "subject", "issuer", "notBeforeAt", "notAfterAt", "fingerprint", "createdAt"]),
    ("sshKey", "SshKey", "sshKeys", ["id", "name", "ownerId", "fingerprint", "lastUsedAt", "expiresAt", "createdAt"]),
    ("gpgKey", "GpgKey", "gpgKeys", ["id", "ownerId", "fingerprint", "publicKey", "expiresAt", "createdAt"]),
    ("deployKey", "DeployKey", "deployKeys", ["id", "name", "repositoryId", "publicKey", "isReadOnly", "createdAt"]),
    ("pipeline", "Pipeline", "pipelines", ["id", "name", "projectId", "definition", "active", "createdAt"]),
    ("pipelineRun", "PipelineRun", "pipelineRuns", ["id", "pipelineId", "status", "triggeredBy", "startedAt", "completedAt"]),
    ("runner", "Runner", "runners", ["id", "name", "kind", "ownerId", "active", "lastSeenAt", "createdAt"]),
    ("runnerGroup", "RunnerGroup", "runnerGroups", ["id", "name", "ownerId", "scopes", "createdAt"]),
    ("artifact", "Artifact", "artifacts", ["id", "pipelineRunId", "name", "contentType", "amountCents", "createdAt", "expiresAt"]),
    ("cacheEntry", "CacheEntry", "cacheEntries", ["id", "key", "scope", "amountCents", "lastUsedAt", "createdAt"]),
    ("channel", "Channel", "channels", ["id", "name", "workspaceId", "visibility", "memberCount", "createdAt"]),
    ("messageEntry", "MessageEntry", "messageEntries", ["id", "channelId", "authorId", "body", "editedAt", "createdAt"]),
    ("thread", "Thread", "threads", ["id", "channelId", "parentMessageId", "memberCount", "createdAt"]),
    ("reaction", "Reaction", "reactions", ["id", "subjectId", "subjectKind", "userId", "emoji", "createdAt"]),
    ("mention", "Mention", "mentions", ["id", "subjectId", "subjectKind", "userId", "acknowledgedAt", "createdAt"]),
    ("application", "Application", "applications", ["id", "name", "ownerId", "clientId", "scopes", "active", "createdAt"]),
    ("integration", "Integration", "integrations", ["id", "name", "kind", "ownerId", "active", "configRef", "createdAt"]),
    ("hookDelivery", "HookDelivery", "hookDeliveries", ["id", "webhookId", "status", "amountCents", "deliveredAt"]),
    ("policy", "Policy", "policies", ["id", "name", "ownerId", "definition", "active", "createdAt"]),
    ("policyRule", "PolicyRule", "policyRules", ["id", "policyId", "condition", "action", "priority", "active"]),
]
