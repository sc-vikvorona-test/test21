import type { BranchService } from './service';
import { BranchValidationError, BranchServiceError } from './service';
...
export class BranchController {
  ...
  handleList(req: HttpRequest): HttpResponse {
    ...
    const sortBy = req.query.sortBy as keyof Branch | undefined;
