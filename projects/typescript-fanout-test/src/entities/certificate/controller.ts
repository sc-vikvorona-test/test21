import type { CertificateService } from './service';
import { CertificateValidationError, CertificateServiceError } from './service';
...
export class CertificateController {
  ...
  handleList(req: HttpRequest): HttpResponse {
    ...
    const sortBy = req.query.sortBy as keyof Certificate | undefined;
