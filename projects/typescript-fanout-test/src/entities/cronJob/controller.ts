import type { CronJobService } from './service';
import { CronJobValidationError, CronJobServiceError } from './service';
...
export class CronJobController {
  ...
  handleList(req: HttpRequest): HttpResponse {
    ...
    const sortBy = req.query.sortBy as keyof CronJob | undefined;
...
function errorToResponse(err: unknown): HttpResponse {
  ...
  if (err instanceof CronJobServiceError) {
