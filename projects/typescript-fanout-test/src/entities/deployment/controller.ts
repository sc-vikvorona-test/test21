...
import { DeploymentValidationError, DeploymentServiceError } from './service';
...
export class DeploymentController {
  ...
  handleList(req: HttpRequest): HttpResponse {
    ...
    const sortBy = req.query.sortBy as keyof Deployment | undefined;
...
function errorToResponse(err: unknown): HttpResponse {
  ...
  if (err instanceof DeploymentValidationError) {
