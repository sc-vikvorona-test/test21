...
import { EnvironmentValidationError, EnvironmentServiceError } from './service';
...
export class EnvironmentController {
  ...
  handleList(req: HttpRequest): HttpResponse {
    ...
    const sortBy = req.query.sortBy as keyof Environment | undefined;
...
function errorToResponse(err: unknown): HttpResponse {
  ...
  if (err instanceof EnvironmentServiceError) {
