...
import { InvitationValidationError, InvitationServiceError } from './service';
...
export class InvitationController {
  ...
  handleList(req: HttpRequest): HttpResponse {
    ...
    const sortBy = req.query.sortBy as keyof Invitation | undefined;
...
function errorToResponse(err: unknown): HttpResponse {
  ...
  if (err instanceof InvitationValidationError) {
