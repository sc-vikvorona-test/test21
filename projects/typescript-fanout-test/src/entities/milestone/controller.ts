import type { MilestoneService } from './service';
import { MilestoneValidationError, MilestoneServiceError } from './service';
...
export class MilestoneController {
  ...
  handleList(req: HttpRequest): HttpResponse {
    ...
    const sortBy = req.query.sortBy as keyof Milestone | undefined;
