...
import { PolicyValidationError, PolicyServiceError } from './service';
...
export class PolicyController {
  ...
  handleList(req: HttpRequest): HttpResponse {
    ...
    const sortBy = req.query.sortBy as keyof Policy | undefined;
...
function errorToResponse(err: unknown): HttpResponse {
  ...
  if (err instanceof PolicyServiceError) {
