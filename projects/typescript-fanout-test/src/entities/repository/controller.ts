...
import { RepositoryValidationError, RepositoryServiceError } from './service';
...
export class RepositoryController {
  ...
  handleList(req: HttpRequest): HttpResponse {
    ...
    const sortBy = req.query.sortBy as keyof Repository | undefined;
...
function errorToResponse(err: unknown): HttpResponse {
  ...
  if (err instanceof RepositoryServiceError) {
