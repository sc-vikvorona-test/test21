import type { SecretService } from './service';
import { SecretValidationError, SecretServiceError } from './service';
...
export class SecretController {
  ...
  handleList(req: HttpRequest): HttpResponse {
    ...
    const sortBy = req.query.sortBy as keyof Secret | undefined;
...
function errorToResponse(err: unknown): HttpResponse {
  ...
  if (err instanceof SecretServiceError) {
