import type { SshKeyService } from './service';
import { SshKeyValidationError, SshKeyServiceError } from './service';
...
export class SshKeyController {
  constructor(private readonly service: SshKeyService) {}
  ...
  handleList(req: HttpRequest): HttpResponse {
    ...
    const sortBy = req.query.sortBy as keyof SshKey | undefined;
...
function errorToResponse(err: unknown): HttpResponse {
  ...
  if (err instanceof SshKeyValidationError) {
