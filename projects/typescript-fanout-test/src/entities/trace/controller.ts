import type { TraceService } from './service';
import { TraceValidationError, TraceServiceError } from './service';
...
export class TraceController {
  ...
  handleList(req: HttpRequest): HttpResponse {
    ...
    const sortBy = req.query.sortBy as keyof Trace | undefined;
...
function errorToResponse(err: unknown): HttpResponse {
  ...
  if (err instanceof TraceServiceError) {
